<header>
    <nav class="border-gray-200 px-4 lg:px-6 py-4 bg-white fixed w-full transition-colors duration-300 ease-in-out" id="navbar">
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            <a href="https://flowbite.com" class="flex items-center">
                <img src="{{ url('/') }}/assets/img/logo.png" class="mr-3 w-10" alt="Flowbite Logo" />
            </a>
            <div class="flex items-center lg:order-2">
                <a href="#" class="text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">Akses</a>
