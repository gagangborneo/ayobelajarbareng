...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Contracts\NotificationService' => \App\Services\WhatsappService::class,
            'App\Contracts\UserPhoneService' => \App\Services\UserPhoneService::class,
            ...
            'blade.compiler' => \ProtoneMedia\Splade\CustomBladeCompiler::class,
            ...
            'laravel-splade-toast' => \ProtoneMedia\Splade\SpladeToastBuilder::class,
    ...
    override(\config(), map([
            ...
            'blade-carbon-icons.prefix' => 'string',
            'blade-carbon-icons.fallback' => 'string',
            'blade-carbon-icons.class' => 'string',
            'blade-carbon-icons.attributes' => 'array',
            ...
            'filesystems.disks.splade_temporary_file_uploads.driver' => 'string',
            'filesystems.disks.splade_temporary_file_uploads.root' => 'string',
            'filesystems.disks.splade_temporary_file_uploads.throw' => 'boolean',
            'filesystems.links./home/asif/Develop/abb/ayobelajarbareng/public/storage' => 'string',
            ...
            'splade.event_redirect_route' => 'string',
            'splade.table_bulk_action_route' => 'string',
            'splade.table_export_route' => 'string',
            'splade.confirm_password_route' => 'string',
            'splade.with_vue_bridge_route' => 'string',
            'splade.confirm_password_guard' => 'NULL',
            'splade.share_session_flash_data' => 'boolean',
            'splade.file_uploads.disk' => 'string',
            'splade.file_uploads.temporary_file_lifetime' => 'integer',
            'splade.file_uploads.route' => 'string',
            'splade.blade.component_prefix' => 'string',
            'splade.blade.table_cell_directive' => 'string',
            'splade.blade.asterisk_on_required_form_elements' => 'boolean',
            'splade.blade.escape_validation_messages' => 'boolean',
            'splade.blade.seo_title_directive' => 'string',
            'splade.blade.seo_description_directive' => 'string',
            'splade.blade.seo_keywords_directive' => 'string',
            'splade.ssr.enabled' => 'boolean',
            'splade.ssr.server' => 'string',
            'splade.ssr.blade_fallback' => 'boolean',
            'splade.dusk.choices_select_macro' => 'string',
            'splade.dusk.choices_remove_item_macro' => 'string',
            'splade.seo.defaults.title' => 'string',
            'splade.seo.defaults.description' => 'string',
            'splade.seo.defaults.keywords' => 'array',
            'splade.seo.title_prefix' => 'string',
            'splade.seo.title_separator' => 'string',
            'splade.seo.title_suffix' => 'string',
            'splade.seo.auto_canonical_link' => 'boolean',
            'splade.seo.open_graph.auto_fill' => 'boolean',
            'splade.seo.open_graph.image' => 'NULL',
            'splade.seo.open_graph.site_name' => 'NULL',
            'splade.seo.open_graph.title' => 'NULL',
            'splade.seo.open_graph.type' => 'NULL',
            'splade.seo.open_graph.url' => 'NULL',
            'splade.seo.twitter.auto_fill' => 'boolean',
            'splade.seo.twitter.card' => 'NULL',
            'splade.seo.twitter.description' => 'NULL',
            'splade.seo.twitter.image' => 'NULL',
            'splade.seo.twitter.site' => 'NULL',
            ...
            'dusk-fakes.bus.enabled' => 'boolean',
            'dusk-fakes.bus.storage_root' => 'string',
            'dusk-fakes.mails.enabled' => 'boolean',
            'dusk-fakes.mails.storage_root' => 'string',
            'dusk-fakes.notifications.enabled' => 'boolean',
            'dusk-fakes.notifications.storage_root' => 'string',
            'dusk-fakes.queue.enabled' => 'boolean',
            'dusk-fakes.queue.storage_root' => 'string',
...
'auth.passwords.users.throttle','auth.password_timeout','blade-carbon-icons.prefix','blade-carbon-icons.fallback','blade-carbon-icons.class',
'blade-carbon-icons.attributes','cache.default','cache.stores.array.driver','cache.stores.array.serialize','cache.stores.database.driver',
...
'filesystems.disks.s3.report','filesystems.disks.splade_temporary_file_uploads.driver','filesystems.disks.splade_temporary_file_uploads.root','filesystems.disks.splade_temporary_file_uploads.throw','filesystems.links./home/asif/Develop/abb/ayobelajarbareng/public/storage',
...
'session.http_only','session.same_site','session.partitioned','splade.event_redirect_route','splade.table_bulk_action_route',
'splade.table_export_route','splade.confirm_password_route','splade.with_vue_bridge_route','splade.confirm_password_guard','splade.share_session_flash_data',
'splade.file_uploads.disk','splade.file_uploads.temporary_file_lifetime','splade.file_uploads.route','splade.blade.component_prefix','splade.blade.table_cell_directive',
'splade.blade.asterisk_on_required_form_elements','splade.blade.escape_validation_messages','splade.blade.seo_title_directive','splade.blade.seo_description_directive','splade.blade.seo_keywords_directive',
'splade.ssr.enabled','splade.ssr.server','splade.ssr.blade_fallback','splade.dusk.choices_select_macro','splade.dusk.choices_remove_item_macro',
'splade.seo.defaults.title','splade.seo.defaults.description','splade.seo.defaults.keywords','splade.seo.title_prefix','splade.seo.title_separator',
'splade.seo.title_suffix','splade.seo.auto_canonical_link','splade.seo.open_graph.auto_fill','splade.seo.open_graph.image','splade.seo.open_graph.site_name',
'splade.seo.open_graph.title','splade.seo.open_graph.type','splade.seo.open_graph.url','splade.seo.twitter.auto_fill','splade.seo.twitter.card',
'splade.seo.twitter.description','splade.seo.twitter.image','splade.seo.twitter.site','splade.seo.twitter.title','splade-seo.defaults.title',
'splade-seo.defaults.description','splade-seo.defaults.keywords','splade-seo.title_prefix','splade-seo.title_separator','splade-seo.title_suffix',
'splade-seo.auto_canonical_link','splade-seo.open_graph.auto_fill','splade-seo.open_graph.image','splade-seo.open_graph.site_name','splade-seo.open_graph.title',
'splade-seo.open_graph.type','splade-seo.open_graph.url','splade-seo.twitter.auto_fill','splade-seo.twitter.card','splade-seo.twitter.description',
'splade-seo.twitter.image','splade-seo.twitter.site','splade-seo.twitter.title','view.paths','view.compiled',
...
'hashing.argon.time','hashing.argon.verify','hashing.rehash_on_login','blade-icons.sets','blade-icons.class',
'blade-icons.attributes','blade-icons.fallback','blade-icons.components.disabled','blade-icons.components.default','dusk-fakes.bus.enabled',
'dusk-fakes.bus.storage_root','dusk-fakes.mails.enabled','dusk-fakes.mails.storage_root','dusk-fakes.notifications.enabled','dusk-fakes.notifications.storage_root',
'dusk-fakes.queue.enabled','dusk-fakes.queue.storage_root','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename',
...
'dusk.login','dusk.logout','dusk.user','splade.eventRedirect',
'splade.withVueBridge','splade.confirmedPasswordStatus','splade.confirmPassword','splade.table.bulkAction','splade.table.export',
'splade.fileUpload.store','splade.fileUpload.delete','dashboard','profile.edit','profile.update','profile.destroy',
'register','login',
'akses','akses.validasi','akses.nomor','akses.nomor.kirim-otp','akses.nomor.kirim-otp.sesi-waktu-mulai',
'akses.nomor.kirim-otp.sesi-waktu-batas','akses.login','password.request','password.email','password.reset',
...
'auth.confirm-password','auth.forgot-password','auth.login','auth.phone.akses','auth.phone.kode',
'auth.phone.phone-code','auth.register','auth.reset-password','auth.verify-email','components.application-logo',
'components.auth-card','components.auth-session-status','components.dropdown','components.dropdown-link','components.nav-link',
'components.responsive-nav-link','dashboard','layouts.app','layouts.footer','layouts.guest',
'layouts.header','layouts.nav-mobile','layouts.navigation','layouts.web','pages.chat-ustad.index',
'pages.chat-ustad.konfirmasi','pages.chat-ustad.selesai','pages.home','profile.edit','profile.partials.delete-user-form',
'profile.partials.update-password-form','profile.partials.update-profile-information-form','root','splade::components.button','splade::components.button-with-dropdown',
'splade::components.confirm','splade::components.dropdown','splade::components.modal','splade::components.modal-wrapper','splade::components.slideover',
'splade::components.toast','splade::components.toast-wrapper','splade::form.checkbox','splade::form.checkboxes','splade::form.error',
'splade::form.file','splade::form.group','splade::form.help','splade::form.input','splade::form.label',
'splade::form.radio','splade::form.radios','splade::form.select','splade::form.select-child','splade::form.submit',
'splade::form.textarea','splade::form.wysiwyg','splade::table.add-search-row','splade::table.body','splade::table.bulk-actions-exports',
'splade::table.columns','splade::table.controls','splade::table.filters','splade::table.global-search','splade::table.head',
'splade::table.pagination','splade::table.per-page-selector','splade::table.search-row','splade::table.select-rows-dropdown','splade::table.simple-pagination',
'splade::table.table','splade::table.wrapper','vendor.splade.components.button','vendor.splade.components.button-with-dropdown','vendor.splade.components.confirm',
'vendor.splade.components.dropdown','vendor.splade.components.modal','vendor.splade.components.modal-wrapper','vendor.splade.components.slideover','vendor.splade.components.toast',
'vendor.splade.components.toast-wrapper','vendor.splade.form.checkbox','vendor.splade.form.checkboxes','vendor.splade.form.error','vendor.splade.form.file',
'vendor.splade.form.group','vendor.splade.form.help','vendor.splade.form.input','vendor.splade.form.label','vendor.splade.form.radio',
'vendor.splade.form.radios','vendor.splade.form.select','vendor.splade.form.select-child','vendor.splade.form.submit','vendor.splade.form.textarea',
'vendor.splade.form.wysiwyg','vendor.splade.table.add-search-row','vendor.splade.table.body','vendor.splade.table.bulk-actions-exports','vendor.splade.table.columns',
'vendor.splade.table.controls','vendor.splade.table.filters','vendor.splade.table.global-search','vendor.splade.table.head','vendor.splade.table.pagination',
'vendor.splade.table.per-page-selector','vendor.splade.table.search-row','vendor.splade.table.select-rows-dropdown','vendor.splade.table.simple-pagination','vendor.splade.table.table',
'vendor.splade.table.wrapper','welcome','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
...
'pagination::simple-tailwind','pagination::tailwind','splade::components.button','splade::components.button-with-dropdown','splade::components.confirm',
'splade::components.dropdown','splade::components.modal','splade::components.modal-wrapper','splade::components.slideover','splade::components.toast',
'splade::components.toast-wrapper','splade::form.checkbox','splade::form.checkboxes','splade::form.error','splade::form.file',
'splade::form.group','splade::form.help','splade::form.input','splade::form.label','splade::form.radio',
'splade::form.radios','splade::form.select','splade::form.select-child','splade::form.submit','splade::form.textarea',
'splade::form.wysiwyg','splade::functional.content','splade::functional.data','splade::functional.dataStores','splade::functional.defer',
'splade::functional.dialog','splade::functional.dynamicHtml','splade::functional.errors','splade::functional.event','splade::functional.flash',
'splade::functional.form','splade::functional.form-builder','splade::functional.html','splade::functional.lazy','splade::functional.link',
'splade::functional.outside','splade::functional.persistent-layout','splade::functional.preloaded-modal','splade::functional.rehydrate','splade::functional.script',
'splade::functional.slot','splade::functional.state','splade::functional.teleport','splade::functional.toggle','splade::functional.transition',
'splade::functional.vue-bridge','splade::table.add-search-row','splade::table.body','splade::table.bulk-actions-exports','splade::table.columns',
'splade::table.controls','splade::table.filters','splade::table.global-search','splade::table.head','splade::table.pagination',
'splade::table.per-page-selector','splade::table.search-row','splade::table.select-rows-dropdown','splade::table.simple-pagination','splade::table.table',
'splade::table.wrapper','splade::transitions.classes',);
...
'validation.url','validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','ar.0',
'bn.0','de.0','en.0','es.0','fa.0',
'fil.0','fr.0','id.0','it.0','ja.0',
'ms.0','ne.0','nl.0','pt_BR.0','pt_PT.0',
'ru.0','uk_UA.0','ur.0','zh_CN.0',);
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','WAHA_API_KEY',
'WAHA_API_URL','WAHA_API_SESSION',);
